...
description: "Hotrod is the open-source Astro starter from Roboto Studio for agent-edited marketing sites — Zod-typed blocks, Mux + Vercel Blob built in, no heavy CMS."
